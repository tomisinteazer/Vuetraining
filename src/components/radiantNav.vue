<template>
    <header class="pt-12 sm:pt-16" data-headlessui-state="">
        <div class="">
            <div
                ...
                <div class="relative flex gap-6">
                    <div class="py-3 group/item relative"><svg viewBox="0 0 15 15" aria-hidden="true"
                            ...
                            <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                        </svg><a title="Home" data-headlessui-state="" href="/"><svg width="127" height="34"
                                viewBox="0 0 127 34" class="h-9 overflow-visible">
                                <g opacity="1" transform-origin="17.000499725341797px 17.000499725341797px"
                                ...
                                <g opacity="1" transform-origin="17px 17.00035572052002px"
                                ...
                                <g opacity="1" transform-origin="17px 17px"
                    ...
                    <div class="relative hidden items-center py-3 lg:flex"><a
                            ...
                            href="/blog/radiant-raises-100m-series-a-from-tailwind-ventures">Radiant raises
                            $100M Series A from Tailwind Ventures<svg xmlns="http://www.w3.org/2000/svg"
                ...
                <nav class="relative hidden lg:flex">
                    <div class="relative flex group/item relative"><svg viewBox="0 0 15 15" aria-hidden="true"
                            class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                            <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                        </svg><svg viewBox="0 0 15 15" aria-hidden="true"
                            class="absolute size-[15px] fill-black/10 -top-2 -right-2">
                            ...
                            data-headlessui-state="" href="/pricing">Pricing</a></div>
                    <div class="relative flex group/item relative"><svg viewBox="0 0 15 15" aria-hidden="true"
                            class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                            <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                        </svg><svg viewBox="0 0 15 15" aria-hidden="true"
                            ...
                            class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                            data-headlessui-state="" href="/company">Company</a></div>
                    <div class="relative flex group/item relative"><svg viewBox="0 0 15 15" aria-hidden="true"
                            class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                            <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                        </svg><svg viewBox="0 0 15 15" aria-hidden="true"
                            ...
                            class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                            data-headlessui-state="" href="/blog">Blog</a></div>
                    <div class="relative flex group/item relative"><svg viewBox="0 0 15 15" aria-hidden="true"
                            class="hidden group-first/item:block absolute size-[15px] fill-black/10 -top-2 -left-2">
                            <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                        </svg><svg viewBox="0 0 15 15" aria-hidden="true"
                            ...
                            class="flex items-center px-4 py-3 text-base font-medium text-gray-950 bg-blend-multiply data-hover:bg-black/[2.5%]"
                            data-headlessui-state="" href="/login">Login</a></div>
                </nav>
                <button
                    class="flex size-12 items-center justify-center self-center rounded-lg data-hover:bg-black/5 lg:hidden"
                    aria-label="Open main menu" id="headlessui-disclosure-button-:r21:" type="button"
                    aria-expanded="false" data-headlessui-state=""><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="size-6">
                        <path fill-rule="evenodd"
