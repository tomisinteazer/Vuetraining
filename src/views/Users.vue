    ...
    <section>
                ...
                <div class="lg:w-4/6 mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row mt-10">
                        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            <div class="w-20 h-20 rounded-full inline-flex  justify-center bg-zinc-900 text-zinc-700">
                                <img alt="team"
                        ...
                        <div
                            class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-zinc-900 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                            ...
                            <router-link to="/store" class="text-green-400 inline-flex items-center"> Support us
        ...
        <section class="text-zinc-400 bg-zinc-950 body-font">
            <div class="container px-5 py-24 mx-auto">
                ...
                <h1 class="py-8 text-5xl  my-4 px-4 rounded-xl  text-white  bg-green-500/50  font-thin">
                    Contributors
                </h1>

                <div class="flex flex-wrap -m-2">
                    <div class="p-2 lg:w-1/4 md:w-1/2 w-full" v-for="(user, i) in store.users" :key="i">
                        <div class="h-full flex items-center border-zinc-700 bg-zinc-900/50 border p-4 rounded-lg">
                            <img alt="team"
                                class="w-16 h-16 bg-zinc-100 object-cover object-center flex-shrink-0 rounded-full mr-4"
                                :src="user.profileImage">
                            <div class="w-1 h-12 bg-green-500 rounded mr-4"></div>
                            <div class="flex-grow">
